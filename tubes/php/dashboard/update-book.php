				...
				<div class="table-content clear">
    				<form action="" method="post" enctype="multipart/form-data">
    					<div class="form-input">
	    					<div class="left">	    						
	    						...
	    						<div>
		    						...
		    						<input type="text" name="judul" id="judul" autofocus required autocomplete="off" value="<?= $book['judul']?>">
	    						</div>
	    						<div>
	    							<label for="author_id">ID Pengarang</label>
	    							<input type="text" name="author_id" id="author_id" autofocus required autocomplete="off" value="<?= $book['author_id']?>">
	    						</div>
	    						<div>
	    							<label for="genre">Genre</label>
	    							<input type="text" name="genre" id="genre" autofocus autocomplete="off" value="<?= $book['genre']?>">
	    						</div>
	    						<div>
	    							<label for="penerbit">Penerbit</label>
	    							<input type="text" name="penerbit" id="penerbit" autofocus autocomplete="off" value="<?= $book['penerbit']?>">
	    						</div>
	    					</div>
	    					<div class="right">
	    						<div>
	    							<label for="thnTerbit">Tahun Terbit</label>
	    							<input type="text" name="thnTerbit" id="thnTerbit" autofocus autocomplete="off" value="<?= $book['thnTerbit']?>">
	    						</div>
	    						<div>
	    							<label for="jmlHal">Jumlah Halaman</label>
	    							<input type="text" name="jmlHal" id="jmlHal" autofocus autocomplete="off" value="<?= $book['jmlHal']?>">
	    						</div>
	    						<div>
	    							<label for="isbn">ISBN</label>
	    							<input type="text" name="isbn" id="isbn" autofocus autocomplete="off" value="<?= $book['isbn']?>">
	    						</div>
	    					...
	    					<div class="clear">
	    						<div>
	    							...
	    							<textarea name="sinopsis" id="sinopsis" class="materialize-textarea" cols="30" rows="10" value="<?= $book['sinopsis']?>"></textarea>
	    						</div>
	    						<div>
	    							<label for="nama_author">Nama Pengarang</label>
	    							<input type="text" name="nama_author" id="nama_author" autofocus autocomplete="off" value="<?= $book['nama_author']?>" disabled="disabled">
	    						</div>
	    					</div>
    					</div>
    					<div class="clear center add-btn">
	    					...
	    					<a class="btn-add" href="table-book.php">
