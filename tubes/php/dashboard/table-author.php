...
$author = query("SELECT * FROM author ORDER BY $order $sort");

$sort == 'DESC' ? $sort = 'ASC' : $sort = 'DESC';

if (isset($_GET['cari'])) {
	$author = cariauthor($_GET['keyword']);
} 
    		...
    		<div class="col l2">
    			<div class="option">
					...
					<div class="action-edit">
						<ul>
							<li><a href="add-author.php"><h6>Tambah Author</h6></a></li>
							<li>|</li>
							<li><a href="../print-author.php" target="_blank""><h6>Print</h6></a></li>
						</ul>
					</div>
					<div class="sorting">
						<h6>Urutkan</h6>
						<ul>
							<li><a href="?order=author_id&&sort=<?= $sort; ?>">Number</a></li>
							<li><a href="?order=nama&&sort=<?= $sort; ?>">Nama</a></li>
						</ul>
					        ...
					        <tbody>
					    		...
					    		<?php foreach($author as $item) : ?>
					          	<tr>
					            	...
					            	<td><a href="update-author.php?author_id=<?= $item['author_id']?>">Update</a> | <a href="delete-author.php?author_id=<?= $item['author_id']?>"onclick="return confirm('Anda yakin ingin menghapus data ini?')">Delete</a></td>
					          	</tr>
					          	<?php endforeach; ?>
					        </tbody>
					    </table>
