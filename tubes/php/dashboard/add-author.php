    					...
    					<div class="form-input">
	    					<div class="left">
	    						<div>
		    						...
		    						<input type="text" name="nama" id="nama" autofocus required autocomplete="off">
	    						</div>
	    						<div>
	    							<label for="alamat">Alamat</label>
	    							<input type="text" name="alamat" id="alamat" autofocus required autocomplete="off">
	    						</div>
	    					</div>
	    					<div class="right">
	    						<div>
	    							<label for="awal_karir">Awal Karir</label>
	    							<input type="text" name="awal_karir" id="awal_karir" autofocus autocomplete="off">
	    						</div>
	    					...
	    					<div class="clear">
	    						<div>
	    							...
	    							<textarea name="deskripsi" id="deskripsi" class="materialize-textarea" cols="30" rows="10" ></textarea>
	    						</div>
	    					</div>
    					</div>
